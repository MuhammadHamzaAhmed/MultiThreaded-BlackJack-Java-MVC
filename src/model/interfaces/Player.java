...
/**
 * <pre>
 * Assignment interface for FP representing the player
...
public interface Player extends Comparable<Player> {
	 ...
	 * @return true if bet is greater than 0 and player has sufficient points to
	 *         place the bet<br>
	 */
	...
	/**
	 * reset the bet to 0 for next round (in case player does not bet again in next
	 * round)
	 */
	public abstract void resetBet();

	/**
	 * @return the result of the most recent hand as set by
	 *         {@link Player#setResult(int)}
	 */
